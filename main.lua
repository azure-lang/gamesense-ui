...
local Passed, Statement = pcall(function()
	...
	effects:CreateSlider({Name = "Transparent props", State = 50, Max = 100, Min = 0, Decimals = 1, Suffix = "%", Callback = function(Value) game.Players.LocalPlayer.Humanoid.WalkSpeed = Value})
